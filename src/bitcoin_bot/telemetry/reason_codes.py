...
REASON_CODE_REGIME_VOLATILITY_SPIKE = "regime_volatility_spike"
REASON_CODE_REGIME_THIN_LIQUIDITY = "regime_thin_liquidity"
...
REASON_CODE_ORDER_SIZE_TOO_SMALL = "order_size_too_small"
